...
public class DefaultJobLauncherApplicationRunner extends JobLauncherApplicationRunner {
    ...
    public void setSfnTaskResultPersistService(
        SfnTaskResultPersistService sfnTaskResultPersistService) {
    ...
    @Override
    protected void execute(@NonNull Job job, @NonNull JobParameters jobParameters)
        ...
        try {
            ...
            // タスクトークンを取得
            String taskToken = env.getProperty(
                jobflowConfigurationProperties.getTaskTokenEnvName());
            ...
            monitoringLogger.error(BatchFrameworkMessageIds.E_FW_BATCH_9001, e,
